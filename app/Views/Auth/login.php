  ...
  <div class="core-auth-card" id="coreAuthCard">
    ...
    <div class="core-auth-form-panel">
      <form method="POST" action="<?= BASE_URL ?>/login" class="core-auth-form" id="formLogin" novalidate>
        ...
        <!-- Flujo por redirección: /auth/google arma el consentimiento y
             Google devuelve al navegador a /auth/google/callback, donde se
             cambia el code por la sesión (ver AuthController.php). -->
