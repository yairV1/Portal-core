<?php $titulo = 'Gestión Institucional'; require ROOT_PATH . '/app/Views/layouts/portal-header.php'; ?>
<link rel="stylesheet" href="<?= BASE_URL ?>/assets/portal/css/gestion-institucional.css">
