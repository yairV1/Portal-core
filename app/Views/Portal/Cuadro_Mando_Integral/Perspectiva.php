...
<link rel="stylesheet" href="<?= BASE_URL ?>/assets/portal/css/cmi-perspectiva.css">
...
<div class="modulo-grid">
  ...
  <div style="display:flex;flex-direction:column;gap:28px">
    <div class="side-box">
      ...
      <p class="text-muted" style="padding:4px 0 0">Sin responsables asignados por ahora.</p>
    </div>
    <div class="side-box">
      <div class="side-box-title">Software relacionado</div>
      <p class="text-muted" style="padding:4px 0 0">Sin software registrado por ahora.</p>
    </div>
  </div>
</div>
